              ...
              <div className="hidden md:flex items-center space-x-2">
                <SignedOut>
                  ...
                  <SignUpButton mode="modal">
                    <Button
                      variant="solid"
                      className="text-sm px-4 py-2 bg-gradient-to-r from-sky-500 to-pink-500 text-white rounded-md"
                    >
                      {t("Sign Up")}
                    </Button>
                  </SignUpButton>
                ...
                <div className="px-2 pt-2 space-y-2">
                  <SignedOut>
                    <div className="flex space-x-2">
                      <SignInButton mode="modal">
                        <Button className="flex-1 text-sm px-4 py-2 border rounded-md">
                          {t("Sign In")}
                        </Button>
                      </SignInButton>
                      <SignUpButton mode="modal">
                        <Button className="flex-1 text-sm px-4 py-2 bg-gradient-to-r from-sky-500 to-pink-500 text-white rounded-md">
                          {t("Sign Up")}
                        </Button>
                      </SignUpButton>
                    </div>
